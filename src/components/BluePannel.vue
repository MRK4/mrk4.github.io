<template>
  <div class="flex flex-col justify-around px-6 pb-8 sm:pb-0 sm:py-14 h-fit w-fit rounded-2xl bg-transparent text-sm">
    ...
    <div class="pt-8 flex flex-col text-center justify-center circular-std-book space-y-4">
